...
public abstract class SearchBase {
	...
	public final SearchResultBean search(Serializable searchBean,
		...
		List<Object> listResult = execute(searchBean, configuration, sortField, sortOrder);

		if (listResult != null) {
			long totalNumberOfResult = configuration.getRowCount() != null ? configuration.getRowCount() : listResult.size();
