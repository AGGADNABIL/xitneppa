...
@Entity
@Table(name="TRACE")
@TableGenerator(name = "PkGen", table = "sequence_generator",
pkColumnName = "GEN_NAME", pkColumnValue = "TRACE_Gen", 
valueColumnName = "GEN_VALUE", initialValue = 0, allocationSize = 100)
public class TraceEntity {
	...
	public String toString() {
		return "TraceEntity [" + "idObject=" + id + ", userID=" + userID
				+ ", action=" + action + ", when=" + actionWhen + ", traceInfoIn="
				+ traceInfoIn + ", traceInfoOut=" + traceInfoOut + "]";
	}
}
